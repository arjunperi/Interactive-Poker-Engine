...
public final class HandCombiner {
    ...
    private static List<Hand> makeAllPossibleHands(List<Hand> allHands, Hand hand, Card[] temporaryHand, int start,
                                         int end, int currentIndex)
        {
            ...
            if(currentIndex<handSize){
                for (int totalHandIndex=start; totalHandIndex<=end && end-totalHandIndex+1 >= handSize-currentIndex; totalHandIndex++)
                {
                    ...
                    makeAllPossibleHands(allHands, hand, temporaryHand, totalHandIndex+1, end, currentIndex+1);
                }
            }
        return allHands;
        }
